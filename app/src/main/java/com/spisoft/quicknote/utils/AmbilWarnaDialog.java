...
public class AmbilWarnaDialog {
	...
	public AmbilWarnaDialog(final Context context, int color, boolean supportsAlpha, OnAmbilWarnaListener listener) {
		...
		mView = LayoutInflater.from(context).inflate(R.layout.ambilwarna_dialog, null);
		viewHue = mView.findViewById(R.id.ambilwarna_viewHue);
		viewSatVal = (AmbilWarnaSquare) mView.findViewById(R.id.ambilwarna_viewSatBri);
		viewCursor = (ImageView) mView.findViewById(R.id.ambilwarna_cursor);
		viewOldColor = mView.findViewById(R.id.ambilwarna_oldColor);
		viewNewColor = mView.findViewById(R.id.ambilwarna_newColor);
		viewTarget = (ImageView) mView.findViewById(R.id.ambilwarna_target);
		viewContainer = (ViewGroup) mView.findViewById(R.id.ambilwarna_viewContainer);
		viewAlphaOverlay = mView.findViewById(R.id.ambilwarna_overlay);
		viewAlphaCursor = (ImageView) mView.findViewById(R.id.ambilwarna_alphaCursor);
		viewAlphaCheckered = (ImageView) mView.findViewById(R.id.ambilwarna_alphaCheckered);
