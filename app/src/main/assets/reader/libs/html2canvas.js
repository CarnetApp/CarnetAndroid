 ...
 */
!function (A, e) {
  "object" == (typeof exports === "undefined" ? "undefined" : _typeof(exports)) && "undefined" != typeof module ? module.exports = e() : "function" == typeof define && define.amd ? define(e) : (A = A || self).html2canvas = e();
}(void 0, function () {
  "use strict";
  /*! *****************************************************************************
  ...
  var nB = ["OL", "UL", "MENU"],
      BB = function BB(A, e, t) {
    for (var r = A.firstChild, n = void 0; r; r = n) {
      if (n = r.nextSibling, cB(r) && 0 < r.data.trim().length) e.textNodes.push(new hn(r, e.styles));else if (QB(r)) {
        var B = sB(r);
