...
!function (a, b, c) {
  ...
  !function (a) {
    ...
    a.extend(a.mobile, {
      ...
      behaviors: {},
      silentScroll: function silentScroll(c) {
    ...
    a.cleanData = function (b) {
      ...
      _createWidget: function _createWidget(b, d) {
    ...
    a.extend(a.mobile, {
      ...
      nsNormalizeDict: d,
      nsNormalize: function nsNormalize(b) {
    ...
    a.extend(a.Widget.prototype, {
      _getCreateOptions: function _getCreateOptions() {
        var d,
            ...
            f = this.element[0],
            g = {};
        if (!a.mobile.getAttribute(f, "defaults")) for (d in this.options) {
    ...
    a.mobile.path = d = {
      ...
      addSearchParams: function addSearchParams(b, c) {
        var e = d.parseUrl(b),
            f = "object" == _typeof(c) ? a.param(c) : c,
            g = e.search || "?";
    ...
    function f(b, c) {
      var f,
          ...
          n,
          o = b.type;
      if (b = a.Event(b), b.type = c, f = b.originalEvent, g = a.event.props, o.search(/^(mouse|click)/) > -1 && (g = E), f) for (l = g.length, i; l;) {
        i = g[--l], b[i] = f[i];
      }
    ...
    a.mobile.behaviors.addFirstLastClasses = {
      _getVisibles: function _getVisibles(a, c) {
        var d;
    ...
    a.widget("mobile.collapsibleset", a.extend({
      ...
      _handleCollapsibleExpand: function _handleCollapsibleExpand(b) {
    ...
    a.widget("mobile.listview", a.mobile.listview, {
      ...
      _afterListviewRefresh: function _afterListviewRefresh() {
        var a,
            ...
            e,
            f = !0;
        if (this._superApply(arguments), this.options.hideDividers) for (a = this._getChildrenByTagName(this.element[0], "li", "LI"), d = a.length - 1; d > -1; d--) {
    ...
    a.widget("mobile.slider", a.extend({
      ...
      refresh: function refresh(b, d, e) {
        ...
        }()), this.handle.addClass("ui-btn" + C + " ui-shadow"), l = this.element, m = !this.isToggleSwitch, n = m ? [] : l.find("option"), o = m ? parseFloat(l.attr("min")) : 0, p = m ? parseFloat(l.attr("max")) : n.length - 1, q = m && parseFloat(l.attr("step")) > 0 ? parseFloat(l.attr("step")) : 1, "object" == _typeof(b)) {
    ...
    a.widget("mobile.textinput", a.mobile.textinput, {
      ...
      keyupTimeout: null,
      _prepareHeightUpdate: function _prepareHeightUpdate(a) {
    ...
    a.widget("mobile.popup", {
      ...
      _handleDocumentVmousedown: function _handleDocumentVmousedown(b) {
    ...
    a.fn.buttonMarkup = function (f, i) {
      ...
      for (j = 0; j < this.length; j++) {
        if (l = this[j], k = i ? {
          alreadyEnhanced: !1,
          unknownClasses: []
        } : d(l.className), m = a.extend({}, k.alreadyEnhanced ? k.options : {}, f), !k.alreadyEnhanced) for (n in o) {
    ...
    a.widget("mobile.controlgroup", a.extend({
      ...
      _themeClassFromOption: function _themeClassFromOption(a) {
    ...
    a.widget("mobile.toolbar", a.mobile.toolbar, {
      ...
      _visible: !0,
      updatePagePadding: function updatePagePadding(c) {
        var d = this.element,
            e = "header" === this.role,
        ...
        this._setHeaders(), c.each(function () {
          ...
          a(this).children().each(function () {
            var e,
                ...
                g = ":nth-child(" + (d + 1) + ")";
            if (this.setAttribute("data-" + a.mobile.ns + "colstart", d + 1), f) for (e = 0; f - 1 > e; e++) {
              d++, g += ", :nth-child(" + (d + 1) + ")";
            }
    ...
    a.widget("mobile.filterable", {
      ...
      _filterItems: function _filterItems(b) {
        ...
        if (null != b) for (e = j.filterCallback || d, f = k.length, c = 0; f > c; c++) {
    ...
    a.widget("ui.tabs", {
      ...
      _ajaxSettings: function _ajaxSettings(b, c, d) {
        ...
        return {
          url: b.attr("href"),
          beforeSend: function beforeSend(b, f) {
