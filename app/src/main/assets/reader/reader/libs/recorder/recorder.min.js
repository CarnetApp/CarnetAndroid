  ...
  return function (t) {
    ...
    (function (e) {
      ...
      n.isRecordingSupported = function () {
        ...
        return t && t.context ? (this.audioContext = t.context, this.closeAudioContext = !1) : (this.audioContext = new o(), this.closeAudioContext = !0), this.audioContext;
        ...
        var o = this;
        return t && t.context ? e.Promise.resolve(t) : e.navigator.mediaDevices.getUserMedia({
        ...
        if ("inactive" === this.state) {
          var e = this;
          return this.initWorker(), this.initAudioContext(t), this.initAudioGraph(), this.initSourceNode(t).then(function (t) {
        ...
        "inactive" !== this.state && (this.state = "inactive", this.monitorGainNode.disconnect(), this.scriptProcessorNode.disconnect(), this.recordingGainNode.disconnect(), this.sourceNode.disconnect(), this.clearStream(), this.encoder.postMessage({
          command: "done"
        }));
        ...
        if (null === t) {
          ...
          }, 0), this.ondataavailable(e), this.onstop();
      ...
      }, n.prototype.ondataavailable = function () {}, n.prototype.onpause = function () {}, n.prototype.onresume = function () {}, n.prototype.onstart = function () {}, n.prototype.onstop = function () {}, t.exports = n;
    }).call(this, o(1));
  }, function (t, e) {
    var o;
