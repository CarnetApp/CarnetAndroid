...
!function (e, t) {
  "object" == (typeof exports === "undefined" ? "undefined" : _typeof(exports)) && "object" == (typeof module === "undefined" ? "undefined" : _typeof(module)) ? module.exports = t() : "function" == typeof define && define.amd ? define([], t) : "object" == (typeof exports === "undefined" ? "undefined" : _typeof(exports)) ? exports.DecoderWorker = t() : e.DecoderWorker = t();
    ...
    (function (t) {
      ...
      o.prototype.decode = function (e) {
        ...
        this.getPageBoundaries(t).map(function (r) {
          ...
          if (2 & s && (this.numberOfChannels = t.getUint8(r + 37, !0), this.init()), i > 1) {
            for (var o = t.getUint8(r + 26, !0), u = r + 27 + o, n = 0; n < o; n++) {
              var f = t.getUint8(r + 27 + n, !0);

              if (this.decoderBuffer.set(e.subarray(u, u += f), this.decoderBufferIndex), this.decoderBufferIndex += f, f < 255) {
                var h = this._opus_decode_float(this.decoder, this.decoderBufferPointer, this.decoderBufferIndex, this.decoderOutputPointer, this.decoderOutputMaxLength, 0),
                    a = Math.ceil(h * this.config.outputBufferSampleRate / this.config.decoderSampleRate);

                this.HEAP32[this.decoderOutputLengthPointer >> 2] = h, this.HEAP32[this.resampleOutputLengthPointer >> 2] = a, this._speex_resampler_process_interleaved_float(this.resampler, this.decoderOutputPointer, this.decoderOutputLengthPointer, this.resampleOutputBufferPointer, this.resampleOutputLengthPointer), this.sendToOutputBuffers(this.HEAPF32.subarray(this.resampleOutputBufferPointer >> 2, (this.resampleOutputBufferPointer >> 2) + a * this.numberOfChannels)), this.decoderBufferIndex = 0;
              }
            }
        ...
        for (var e = 0; e < this.numberOfChannels; e++) {
          this.outputBuffers.push(new Float32Array(this.config.bufferLength)), this.outputBufferArrayBuffers.push(this.outputBuffers[e].buffer);
        }
      }, o.prototype.sendLastBuffer = function () {
        this.sendToOutputBuffers(new Float32Array((this.config.bufferLength - this.outputBufferIndex) * this.numberOfChannels)), t.postMessage(null);
      }, o.prototype.sendToOutputBuffers = function (e) {
        for (var r = 0, s = e.length / this.numberOfChannels; r < s;) {
          var i = Math.min(s - r, this.config.bufferLength - this.outputBufferIndex);
          if (1 === this.numberOfChannels) this.outputBuffers[0].set(e.subarray(r, r + i), this.outputBufferIndex);else for (var o = 0; o < i; o++) {
            this.outputBuffers.forEach(function (t, s) {
              t[this.outputBufferIndex + o] = e[(r + o) * this.numberOfChannels + s];
            }, this);
          }
          r += i, this.outputBufferIndex += i, this.outputBufferIndex == this.config.bufferLength && (t.postMessage(this.outputBuffers, this.outputBufferArrayBuffers), this.resetOutputBuffers());
        }
      }, Module || (Module = {}), Module.mainReady = i, Module.OggOpusDecoder = o, Module.onRuntimeInitialized = s, e.exports = Module;
    }).call(this, r(1));
  }, function (e, t) {
    var r;
...
function integrateWasmJS() {
  var wasmTextFile = "decoderWorker.min.wast";
  var wasmBinaryFile = "decoderWorker.min.wasm";
  var asmjsCodeFile = "decoderWorker.min.temp.asm.js";
